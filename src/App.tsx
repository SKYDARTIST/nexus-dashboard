...
const App: React.FC = () => {
  ...
  const fetchAllData = async () => {
    setLoading(true);
    await Promise.all([fetchTransactions(), fetchUsers(), fetchSessions(), fetchAnalytics()]);
    setLoading(false);
  };
  ...
  // Session metrics - count unique users, not sessions
  ...
  // 24H active includes anonymous users from analytics
  // Get device_ids that have signed in (from sessions table)
  ...
  // Signed-in users (24H) - count unique devices from sessions
  ...
  // Anonymous users (24H) - devices in analytics but NOT in sessions
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="nexus-glass rounded-[2rem] p-6 space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-black uppercase text-[9px] tracking-widest text-gray-400">Tool Usage</h3>
                  <p className="text-[8px] text-gray-600 uppercase tracking-wider">Most Popular</p>
                </div>
              </div>
              <RefreshCw
                  ...
                  return (
                    <div key={idx} className="space-y-1">
                      <div className="flex justify-between text-[10px]">
                        <span className="font-bold text-white truncate max-w-[120px]">{tool.tool_name}</span>
                        <span className="text-gray-500 flex-shrink-0">{tool.opens}</span>
                      </div>
                      ...
                      <p className="text-[8px] text-gray-600">
                        {tool.unique_users} user{tool.unique_users !== 1 ? 's' : ''}
                      </p>
                    </div>
                  );
                })
          ...
          <div className="nexus-glass rounded-[2rem] p-6 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-black uppercase text-[9px] tracking-widest text-gray-400">Daily Devices</h3>
              ...
              {dailyDevices.slice(0, 7).map((day, idx) => {
                ...
                return (
                  <div key={idx} className="flex items-center gap-2">
                    <span className="text-[9px] font-bold text-gray-500 w-12 flex-shrink-0">{dateStr}</span>
                    <div className="flex-1 h-6 bg-black/30 rounded-xl overflow-hidden relative">
                      <motion.div
                        initial={{ width: 0 }}
                        animate={{ width: `${percentage}%` }}
                    ...
                    <span className="text-[8px] text-gray-600 w-10 text-right flex-shrink-0">
                      {day.total_events}
                    </span>
                  </div>
                );
          ...
          <div className="nexus-glass rounded-[2rem] p-6 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-black uppercase text-[9px] tracking-widest text-gray-400">User Breakdown</h3>
              ...
              <div className="space-y-2">
                ...
                <div className="h-2 bg-black/30 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{ width: `${active24h > 0 ? (signed24h / active24h) * 100 : 0}%` }}
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="h-2 bg-black/30 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{ width: `${active24h > 0 ? (anonymous24h / active24h) * 100 : 0}%` }}
                  />
                </div>
              </div>

              <div className="flex justify-between items-center pt-3 border-t border-white/5">
                <span className="text-[10px] font-bold text-white">Total Active</span>
